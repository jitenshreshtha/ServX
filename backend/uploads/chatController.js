...
module.exports = (server) => {
  ...
  try {
    const { senderId, recipientId, listingId, fileName, fileData, fileType, senderName } = data;
    ...
    if (!conversation) {
      conversation = new Conversation({ participants: [senderId, recipientId], listing: listingId });
      await conversation.save();
    }
